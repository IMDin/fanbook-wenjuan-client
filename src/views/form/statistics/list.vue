...
// 尾部固定标签
const fixedDefaultFormTailColumn = ['submitAddress', 'createTime','guildName']
const fixedDefaultLabelFormTailColumn = { submitAddress: '提交地址', createTime: '提交时间',guildName:'服务器'}
