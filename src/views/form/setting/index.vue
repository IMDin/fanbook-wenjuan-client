    ...
    >
      ...
      >
        ...
        <el-row v-if="projectSetting.showPromptText">
          ...
          >
            <el-input
              v-model="userProjectSettingData.submitPromptText"
              :maxlength="50"
      ...
      >
        ...
        <div v-if="projectSetting.timingQuantitativeForm">
          ...
          <el-row
            v-if="projectSetting.timingQuantitativeForm"
            align="middle"
            type="flex"
          >
            <el-col :span="8">
        ...
        <div v-if="projectSetting.newFeedbackRemind">
          ...
          <el-row
            v-if="projectSetting.newFeedbackRemindEmail"
            align="middle"
            type="flex"
          >
            <el-col
          ...
          <el-row
            v-if="userProjectSettingData.newWriteNotifyWx"
            align="middle"
            type="flex"
          >
            <el-col
            ...
            <el-col :span="12">
              ...
              >
                <i
                  class="el-icon-close sub-user-delete"
      ...
      >
        ...
        <el-row
          v-if="projectSetting.customizeShareIcon"
          align="middle"
          type="flex"
        >
          <el-col :span="10">
              ...
              <div class="share-preview-msg-box">
                ...
                <div class="share-preview-info">
                  ...
                  <div class="share-preview-img-box">
                    <img
                      v-if="userProjectSettingData.shareImg"
                      :src="userProjectSettingData.shareImg"
